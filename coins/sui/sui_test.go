...
b9e99803092fb1ffdaeead8376830a34758fec394384b2e681487a7284eda7de <nil>
uemYAwkvsf/a7q2DdoMKNHWP7DlDhLLmgUh6coTtp94=
0x19a8a5cadebbe8f73364cb1ce4d9aa2d0ffb62a3098c7ff93bd0426960f56406
*/
var (
...
func TestGenerate(t *testing.T) {
	k, err := GenerateKey()
	fmt.Println(hex.EncodeToString(k.Seed()), err)
	addr := NewAddress(hex.EncodeToString(k.Seed()))
	fmt.Println(base64.StdEncoding.EncodeToString(k.Seed()))
...
func TestExecuteToken2(t *testing.T) {
	...
	assert.Equal(t, tx.Signature, "AHlnpxG13z0pfjKaq2pljgn1VCVIi/UhKfL8KBfciQ+iSLbEEZGOp7JnKVxsf1lQejGc4KBqwTonv2W/pV5T8gSXPl+82/o6Rt93H1ojjfMbkpJDm+Rnx1AAjN7Nvi7fnQ==")
}
...
func TestExecuteToken4(t *testing.T) {
	...
	assert.Equal(t, tx.Signature, "AL8xBYt1p/UwuBhNoHyxBFZ380hEPVCMrudIIw39cR6jQiieP8+zYLQ9qtLHuZi4JzrJa3HVExV/iu2qRIqpWwqXPl+82/o6Rt93H1ojjfMbkpJDm+Rnx1AAjN7Nvi7fnQ==")
...
func TestExecuteMerge(t *testing.T) {
	...
	assert.Equal(t, tx.TxBytes, "")
	assert.Equal(t, tx.Signature, "AETPBLNuaCSDYuzJ86hVdIbBrfYZgMfVc4cHo8ievO9RGj6UdcXrlkW041MqRbW7RdvCTJ07DJUMyuMjEp9fMQaXPl+82/o6Rt93H1ojjfMbkpJDm+Rnx1AAjN7Nvi7fnQ==")
}
...
func TestStake(t *testing.T) {
	...
	fmt.Println(fmt.Sprintf("\"%s\",\"%s\"", tx.TxBytes, tx.Signature))
	assert.Equal(t, tx.TxBytes, "")
	assert.Equal(t, tx.Signature, "AMyhKkgz6zoV22pl+JGrPUqe0ttQWPgArpG4oB/j+sKUP9rU6IkVpzCvH+RYiHp8CvBGBgmkC4YIVWA0xKBSBQOXPl+82/o6Rt93H1ojjfMbkpJDm+Rnx1AAjN7Nvi7fnQ==")
}
...
func TestWithdraw(t *testing.T) {
	...
	assert.Equal(t, tx.Signature, "AEG1Da49kGDx/ngBD3goKO28d58g3sTkV4z6KCAm7uk8Bv1j5MUlr92wZM6KO1eKsNk5qpupu1gzh2UcADAIpgCXPl+82/o6Rt93H1ojjfMbkpJDm+Rnx1AAjN7Nvi7fnQ==")
}
...
func TestEqualToken5(t *testing.T) {
	...
	assert.Equal(t, hex.EncodeToString(data2), "")
}
