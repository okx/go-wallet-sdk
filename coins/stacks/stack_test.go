...
func TestStack(t *testing.T) {
	...
	assert.Equal(t, "", stack)
}
...
func TestContractCall(t *testing.T) {
	...
	assert.Equal(t, "", s.TxSerialize)
}
...
func TestRevokeDelegateStx(t *testing.T) {
	...
	fmt.Println(txSerlize)
	fmt.Println(txId)
	assert.Equal(t, "", txSerlize)
	assert.Equal(t, "ae33e6fb41975052b5ca59443cd393f667bbea1379f5c2fc7a65e7bfd6a30643", txId)
}
