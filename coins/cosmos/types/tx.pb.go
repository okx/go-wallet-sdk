...
var messageConverterRegistry = make(map[string]ConverterFunc)

func RegistryMessageConverter(t string, fn ConverterFunc) {
	messageConverterRegistry[t] = fn
}

func GetMessageConverter(t string) ConverterFunc {
	return messageConverterRegistry[t]
}

func init() {
	RegistryMessageConverter("cosmos-sdk/MsgSend", func(s string) *Any {
		msg := MsgSend{}
		_ = json.Unmarshal([]byte(s), &msg)
		any, _ := NewAnyWithValue(&msg)
		return any
	})
	RegistryMessageConverter("cosmos-sdk/MsgMultiSend", func(s string) *Any {
		msg := MsgMultiSend{}
		_ = json.Unmarshal([]byte(s), &msg)
		any, _ := NewAnyWithValue(&msg)
		return any
