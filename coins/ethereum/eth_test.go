...
func TestEth(t *testing.T) {
	...
	tx := transaction.SignTransaction(big.NewInt(int64(10)), prvKey)
	...
	b, _ := hex.DecodeString("//todo please replace your key")
...
func TestEthToken(t *testing.T) {
	...
	transfer, _ := token.Transfer("0x2de4898dd458d6dce097e29026d446300e3815fa", big.NewInt(int64(100000000000000000)))
	transaction := NewEthTransaction(
		big.NewInt(int64(00)),
		big.NewInt(int64(420000)),
		big.NewInt(int64(200000000000)),
